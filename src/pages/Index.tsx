        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { icon: "MapPin", title: "Далеко", desc: "Часы в пробках, дорогой бензин, усталость вместо отдыха", gradient: "from-orange-500 to-amber-500" },
              { icon: "Wrench", title: "Много хлопот", desc: "Постоянный ремонт, охрана участка, зимнее обслуживание", gradient: "from-amber-500 to-yellow-500" }
            ].map((item, i) => (
      ...
      <section id="benefits" className="py-32 px-6 bg-gradient-to-br from-emerald-50 to-green-50">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-12 md:p-16 shadow-2xl ring-1 ring-gray-900/5">
            <h3 className="text-4xl font-bold mb-12 text-center text-gray-900">Что входит в членство</h3>
            <div className="grid md:grid-cols-2 gap-8">
              {[
                { icon: "Home", title: "Готовая теплица", items: ["Площадь от 20 до 50 м²", "Система полива и отопления", "Качественная почва", "Стеллажи и инвентарь"], color: "emerald" },
      ...
      <section className="py-32 px-6 bg-white">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { season: "Весна", icon: "🌸", crops: ["Редис", "Салат", "Укроп", "Лук", "Рассада томатов"], gradient: "from-pink-400 to-rose-400" },
