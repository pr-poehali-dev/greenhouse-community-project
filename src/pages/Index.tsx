        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-20">
            {[
              ...
              <Card
                key={i}
                className="animate-fade-in hover:shadow-2xl transition-all duration-300 border-0 bg-white/80 backdrop-blur-sm hover:-translate-y-2"
              >
                <CardContent className="pt-10 pb-10">
                  <div
                    className={`w-20 h-20 bg-gradient-to-br ${item.gradient} rounded-3xl flex items-center justify-center mb-8 shadow-xl`}
                  >
                    <Icon
                      name={item.icon as any}
                      size={40}
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-12 md:p-16 shadow-2xl ring-1 ring-gray-900/5">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-emerald-600 font-semibold">
                Приезжайте с пустыми руками — всё уже здесь
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              {[
                {
                  icon: "Home",
                  title: "Всё уже готово",
                  items: [
                    "Автополив — вода всегда есть",
                    "Плодородная почва на месте",
                    "Все инструменты в теплице",
                ...
                },
                {
                  ...
                  items: [
                    ...
                    "Мастер-классы от агронома",
                    "Праздники урожая",
                    "Обмен опытом и рассадой",
                  ],
                  color: "green",
                },
                {
                ...
                },
                {
                  ...
                  items: [
                    ...
                    "Помощь в выборе культур",
                    "Советы по выращиванию",
                    "Решение проблем с урожаем",
                  ],
                  color: "cyan",
                },
              ].map((block, i) => (
                <Card
                  key={i}
                  className="border-0 shadow-lg hover:shadow-xl transition-all bg-gradient-to-br from-white to-gray-50"
                >
                  <CardContent className="pt-8 pb-8">
                    <div className="flex items-start gap-5">
                      <div
                        className={`w-14 h-14 bg-gradient-to-br from-${block.color}-400 to-${block.color}-600 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg`}
                      >
                        <Icon
      ...
      <section className="py-32 px-6 bg-white">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-6 text-gray-900">
              Сезонность выращивания
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Начинайте с рассады весной — выращивайте её прямо в теплице.
              Благодаря отоплению собирайте урожай круглый год
            </p>
          </div>
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                season: "Лето",
                icon: "☀️",
                crops: ["Томаты", "Огурцы", "Перцы", "Баклажаны", "Зелень"],
                gradient: "from-yellow-400 to-orange-400",
              },
              {
                season: "Осень",
                icon: "🍂",
                crops: ["Капуста", "Свёкла", "Морковь", "Зелень", "Редька"],
                gradient: "from-orange-400 to-amber-500",
              },
              {
                season: "Зима",
                icon: "❄️",
                crops: ["Зелень", "Микрозелень", "Салаты", "Шпинат", "Руккола"],
                gradient: "from-blue-400 to-cyan-400",
              },
            ].map((season, i) => (
              <Card
                key={i}
                className="animate-fade-in hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-0 bg-gradient-to-br from-white to-gray-50 overflow-hidden"
              >
                <div
                  className={`h-2 bg-gradient-to-r ${season.gradient}`}
                ></div>
                <CardContent className="pt-8 pb-8">
            ...
            {[
              {
                name: "Анна, 34",
                story:
                  "Раньше покупала зелень в магазине — безвкусная. Теперь круглый год свой базилик, руккола и салаты. Дети в восторге!",
                img: "https://cdn.poehali.dev/projects/d80de847-ec76-47df-9810-364313f6f372/files/0de12d4c-8756-4c33-9f9e-1a73f76ddc86.jpg",
              },
              {
                name: "Михаил, 42",
                story:
                  "Нашёл здесь не просто теплицу, а друзей. Каждые выходные — как маленький отпуск. Обмениваемся опытом, пьём чай в беседке.",
                img: "https://cdn.poehali.dev/projects/d80de847-ec76-47df-9810-364313f6f372/files/24eb7dba-1007-431d-8549-dfd0fe5f2582.jpg",
              },
              {
                name: "Елена, 38",
                story:
                  "Мечтала о даче, но поняла — не готова к хлопотам. ТеплиЦапля — идеальное решение! Все блага без головной боли.",
                img: "https://cdn.poehali.dev/projects/d80de847-ec76-47df-9810-364313f6f372/files/cf35ae38-868c-48cd-b859-4377c3ffa5a4.jpg",
              },
            ].map((person, i) => (
              <Card
                key={i}
                className="animate-fade-in overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-0 bg-white"
              >
      ...
      <section id="pricing" className="py-32 px-6 bg-white">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Выберите размер теплицы по вашим потребностям. Все клубные
              преимущества включены в каждый тариф
            </p>
          </div>
            ...
            {[
              {
                ...
                price: "15 000",
                features: [
                  "Теплица 4×5 м с автополивом",
                  "Идеально для зелени и салатов",
                  "Рассада весной — урожай летом",
                  "Все инструменты на месте",
                ],
                popular: false,
                image:
                  "https://cdn.poehali.dev/projects/d80de847-ec76-47df-9810-364313f6f372/files/4ba24fef-7d18-45f6-8fd6-fab507717fa1.jpg",
              },
              {
                name: "Комфорт",
                size: "35 м²",
                price: "24 000",
                features: [
                  "Теплица 5×7 м с отоплением",
                  "Овощи + зелень круглый год",
                  "Выращивание рассады в теплице",
                  "Приоритет на мастер-классах",
                ],
                popular: true,
                image:
                  "https://cdn.poehali.dev/projects/d80de847-ec76-47df-9810-364313f6f372/files/dc0b3eb0-baf4-4c06-99c1-103ee7373a1b.jpg",
              },
              {
                name: "Премиум",
                size: "50 м²",
                price: "32 000",
                features: [
                  "Теплица 6×8 м с умным управлением",
                  "📱 Удалённый контроль полива",
                  "🚚 Задание на сбор и доставку урожая",
                  "VIP-поддержка агронома 24/7",
                ],
                popular: false,
                image:
                  "https://cdn.poehali.dev/projects/d80de847-ec76-47df-9810-364313f6f372/files/e1e1e216-2c62-43e6-a441-82709f35f0d2.jpg",
              },
            ].map((plan, i) => (
              <Card
                key={i}
                className={`animate-fade-in relative border-0 shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden ${plan.popular ? "scale-105 bg-gradient-to-br from-emerald-600 to-green-600 text-white" : "bg-white hover:-translate-y-2"}`}
              >
                {plan.popular && (
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  />
                  <div
                    className={`absolute inset-0 ${plan.popular ? "bg-gradient-to-t from-emerald-600/90 to-transparent" : "bg-gradient-to-t from-black/40 to-transparent"}`}
                  ></div>
                </div>
                <CardContent className="pt-8 pb-10">
                  <h3
                    className={`text-3xl font-bold text-center mb-2 ${plan.popular ? "text-white" : "text-gray-900"}`}
                  >
                    {plan.name}
                  </h3>
                  <p
                    className={`text-center mb-6 ${plan.popular ? "text-emerald-100" : "text-gray-600"}`}
                  >
                    {plan.size}
                  </p>
                  <div className="text-center mb-8">
                    <span
                      className={`text-5xl font-bold ${plan.popular ? "text-white" : "text-emerald-600"}`}
                    >
                      {plan.price}
                    </span>
                    <span
                  ...
                  <ul className="space-y-4 mb-10">
                    {plan.features.map((feature, j) => (
                      <li key={j} className="flex items-start gap-3">
                        <Icon
                          name="Check"
                          className={`flex-shrink-0 mt-0.5 ${plan.popular ? "text-white" : "text-emerald-600"}`}
                          size={22}
                        />
                        <span
                          className={`leading-relaxed ${plan.popular ? "text-white" : "text-gray-700"}`}
                        >
                          {feature}
                        </span>
                      </li>
          ...
          <p className="text-center text-gray-600 mt-12 text-lg">
            Все тарифы включают: доступ к инфраструктуре, участие в клубных
            мероприятиях, поддержку агронома
          </p>
        </div>
      </section>
                ...
                <div className="flex items-start gap-5 p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Московская область, 15 км от МКАД по Новорижскому шоссе
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-5 p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Удобный подъезд, бесплатная парковка на 50 мест
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-5 p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Ежедневно с 8:00 до 22:00. Доступ 24/7 для
                      премиум-участников
                    </p>
                  </div>
                </div>
            ...
            {[
              {
                ...
                a: "Совершенно нет! Наш агроном проведёт вводный инструктаж и будет консультировать вас на всех этапах. В сообществе всегда помогут советом.",
              },
              {
                q: "Что если я не смогу приезжать каждую неделю?",
                a: "Система автополива поддержит ваши растения. Можно договориться с соседями по клубу о взаимопомощи. Минимум — раз в 2 недели.",
              },
              {
                q: "Можно ли привозить детей?",
                a: "Да! У нас семейная атмосфера. Детская площадка, зона отдыха, безопасная территория. Многие участники приезжают всей семьёй.",
              },
              {
                q: "Что входит в стоимость аренды?",
                a: "Теплица с оборудованием, вода, электричество, отопление, базовый инвентарь, доступ к инфраструктуре, участие во всех клубных мероприятиях.",
              },
              {
                q: "Можно ли продлить или сменить тариф?",
                a: "Конечно! Договор гибкий. Можно перейти на больший или меньший размер при наличии свободных теплиц.",
              },
              {
                q: "Как проходят мастер-классы?",
                a: "Каждую субботу агроном проводит практические занятия: посадка, уход, борьба с вредителями, подкормка. Бесплатно для всех участников.",
              },
            ].map((item, i) => (
              <AccordionItem
                key={i}
                value={`item-${i}`}
                className="bg-gradient-to-br from-white to-gray-50 border-0 shadow-lg rounded-2xl px-8"
              >
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed text-lg">
                Тепличный клуб для горожан. Выращивайте свои овощи, общайтесь с
                единомышленниками.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-300 leading-relaxed text-lg">
                ...
                <br />
                Доступ 24/7 для премиум-участников
              </p>
            </div>
          </div>
